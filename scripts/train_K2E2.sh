...
python train.py --dataroot /public_bme2/bme-wangqian2/songhy2024/data/PVWMI/T1w/k2E-PHILIPS-INGENIA-3.0T/ \
    --csv_path /public_bme2/bme-wangqian2/songhy2024/harmonization_mri/dataset/PVWMI_data.csv \
    --name CUT_monai_K2E2 --model cut --direction AtoB \
