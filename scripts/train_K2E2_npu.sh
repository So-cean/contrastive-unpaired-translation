...
torchrun --nproc_per_node=8 train.py --dataroot /home_data/home/songhy2024/data/PVWMI/T1w/k2E-PHILIPS-INGENIA-3.0T/\
    --name CUT_monai_K2E2_npu --model cut --direction AtoB \
